...
use App\Http\Controllers\AdminspaceindexController;
...
Route::get('/admin/spaces', [AdminspaceindexController::class, 'index'])->name('admin.spaces_index');
Route::delete('/admin/spaces/{id}', [AdminspaceindexController::class, 'destroy'])->name('admin.spaces_destroy');
